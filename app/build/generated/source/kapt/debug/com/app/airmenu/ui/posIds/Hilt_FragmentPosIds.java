...
public abstract class Hilt_FragmentPosIds extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentPosIds(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentPosIds_GeneratedInjector) this.generatedComponent()).injectFragmentPosIds(UnsafeCasts.<FragmentPosIds>unsafeCast(this));
    }
  }
