...
public abstract class Hilt_FragmentNotificationAccess extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentNotificationAccess() {
    super();
  }

  Hilt_FragmentNotificationAccess(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentNotificationAccess_GeneratedInjector) this.generatedComponent()).injectFragmentNotificationAccess(UnsafeCasts.<FragmentNotificationAccess>unsafeCast(this));
    }
  }
