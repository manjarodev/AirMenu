...
public abstract class Hilt_FragmentLogin extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentLogin(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentLogin_GeneratedInjector) this.generatedComponent()).injectFragmentLogin(UnsafeCasts.<FragmentLogin>unsafeCast(this));
    }
  }
