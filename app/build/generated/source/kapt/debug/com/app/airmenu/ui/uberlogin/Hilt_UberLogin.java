...
public abstract class Hilt_UberLogin extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UberLogin(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UberLogin_GeneratedInjector) this.generatedComponent()).injectUberLogin(UnsafeCasts.<UberLogin>unsafeCast(this));
    }
  }
