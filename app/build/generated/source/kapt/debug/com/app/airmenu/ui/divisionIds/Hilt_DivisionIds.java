...
public abstract class Hilt_DivisionIds extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DivisionIds(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DivisionIds_GeneratedInjector) this.generatedComponent()).injectDivisionIds(UnsafeCasts.<DivisionIds>unsafeCast(this));
    }
  }
